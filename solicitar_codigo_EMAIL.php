<?php
// solicitar_codigo.php - CON ENVÍO DE EMAIL
    ...
    if (isset($request_data['email'])) {
        ...
        if ($email_exists) {
            ...
            if ($stmt_insert->execute()) {
                ...
                // Configurar el asunto y mensaje del email
                ...
                $headers .= "Reply-To: noreply@pnkcl.com" . "\r\n";
                ...
                if ($email_sent) {
                    ...
                    // $response['debug_code'] = $code; // Comentar en producción
                } else {
                    // Aunque el email falle, el código está en la BD
                    $response['status'] = 'success';
                    $response['message'] = 'Código generado. (DEBUG: ' . $code . ')';
                    $response['email_warning'] = 'El envío de email puede tener problemas. Usa el código mostrado.';
                }
            } else {
